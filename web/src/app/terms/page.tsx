...
export const metadata: Metadata = {
  ...
  description:
    "The terms that govern your use of Slide, the phone-only video calling app.",
};
  ...
  return (
    <LegalShell title="Terms of Service" updated="May 28, 2026">
      <Section heading="Agreement">
        <p>
          These Terms of Service govern your access to and use of Slide, a
          phone-only video calling app. By creating an account or using the app,
          you agree to these terms. If you do not agree, do not use Slide.
        </p>
      </Section>
      ...
      <Section heading="Eligibility and your account">
        <p>
          ...
          country) to use Slide. Your account is tied to your mobile phone
        ...
        <p>
          ...
          Slide account first, as the number may later be reassigned to someone
          else.
        </p>
      </Section>

      <Section heading="Acceptable use">
        <p>You agree not to use Slide to:</p>
        <p>
      ...
      <Section heading="Your content">
        <p>
          Slide transmits your live audio, video, and screen-share streams to the
      ...
      <Section heading="Service availability">
        <p>
          We work hard to keep Slide reliable, but the service is provided on an
      ...
      <Section heading="Privacy">
        <p>
          Your use of Slide is also governed by our{" "}
          <a
            href="/privacy"
      ...
      <Section heading="Disclaimers and limitation of liability">
        <p>
          To the fullest extent permitted by law, Slide and its providers
      ...
      <Section heading="Termination">
        <p>
          You may stop using Slide and delete your account at any time from within
      ...
      <Section heading="Changes to these terms">
        <p>
          ...
          you in the app. Continued use of Slide after changes take effect means
